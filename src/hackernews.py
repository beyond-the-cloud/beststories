...
KAFKA_COUNTER = Counter("beststories_kafka_counter", "Count of beststories sending message to kafka")
REQUEST_TIME = Summary('beststories_kafka_duration', 'Time beststories kafka producer spent sending messages')
COUNTER = Counter('beststories_hackernews_counter', 'Count of beststories visiting HackerNews')
